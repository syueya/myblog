...
接口选择自己想要的部署，方法都差不多，这里以 kimi 为例

### 1、部署 kimi-free-api

1、拉取 vinlic/kimi-free-api 镜像

2、部署 kimi-free-api 容器
...
1、获取 kimi 渠道密钥，获取方法查看：https://github.com/LLM-Red-Team/kimi-free-api

2、打开 OpenAI 后台，点击渠道-添加渠道

![img](./img/openai-13.png)

3、提交后可以看到添加的渠道，可以点击测试查看状态

![img](./img/openai-14.png)

### 其他说明

1、所有接口相关文档可以查看：`https://github.com/LLM-Red-Team`，可以点击查看相对应的，按需配置即可。画图的可以选讯飞、智谱、阿里，语音的话选海螺。
