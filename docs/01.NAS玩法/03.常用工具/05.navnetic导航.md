...
5、点击设置按钮可以设置自定义名称和背景图

![img](./img/navnetic-04.png)

6、设置里可以生成apikey
![img](./img/navnetic-05.png)

> 注意：1.0.7版本及以上加入了apikey，编辑等操作需要用到，否则会报鉴权错误。

7、可以搭配[navnetic-api](https://github.com/syueya/myskills/tree/main/navnetic-api)技能在小龙虾或者爱马仕上使用