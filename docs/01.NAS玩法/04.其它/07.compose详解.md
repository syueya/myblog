...
### 顶级字段
compose模板文件具体的说明可以查看文档：[compose-file](https://docs.docker.com/reference/compose-file/)。
...
在这几个顶级字段里，我们一般用的都是服务(services)字段。
...
服务字段也有很多属性，我们也不一一讲解，只讲解几个常用的属性，具体的可以看[服务属性](https://docs.docker.com/reference/compose-file/services/#attributes)。
