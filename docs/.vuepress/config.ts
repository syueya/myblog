...
const DOMAIN_NAME = 'myblog.246855.xyz' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: '电脑技巧',
        link: '/computer/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
        items: [
        ],
      },
    ...
    repo: 'syueya/myblog', // 导航栏右侧生成Github链接
    ...
    footer: {
      ...
      copyrightInfo:
        '夏夏子 | <a href="https://github.com/syueya/myblog/blob/main/LICENSE" target="_blank">MIT License</a> ', // 博客版权信息，支持a标签或换行标签</br>
    },
  ...
  head: [
    ['link', { rel: 'icon', href: '/img/syue.ico' }], //图标，资源放在public文件夹
    [
      'meta',
      {
        name: 'keywords',
    ...
    [
      'vuepress-plugin-comment', // 评论
      {
        ...
        options: {
          ...
          owner: 'syueya', // GitHub仓库所有者
          admin: ['syueya'], // 对仓库有写权限的人
